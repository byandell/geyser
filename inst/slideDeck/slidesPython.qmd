...
## Modular Geyser Components {.scrollable .smaller}
...
- [inst/connect_modules/app_pages.py](https://github.com/byandell/geyser/blob/main/inst/connect_modules/app_pages.py)
...
R Shiny app 
- [geyser/rows.py](https://github.com/byandell/geyser/blob/main/geyser/rows.py):
Python Shiny app
- [inst/connect_modules/rows.qmd](https://github.com/byandell/geyser/blob/main/inst/connect_modules/rows.qmd):
Quarto version
