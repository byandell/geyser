...
[Shiny Module](https://github.com/byandell/geyser/blob/main/inst/build_module/4_moduleServer)
[3-9]
  - Faithful code [3-4]
  - Modular Geyser App [5-6]
  - Shiny module in one file [7-9]
  - Reactlog [10-11]
- Connect Modules [12-18]
  - across [Pages](https://github.com/byandell/geyser/blob/main/inst/connect_modules/appPages.R) [12-13]
  - with [Rows and Columns](https://github.com/byandell/geyser/blob/main/inst/connect_modules/appRows.R) [14-15]
  - combined with [Switch](https://github.com/byandell/geyser/blob/main/inst/connect_modules/app.R) [16-17]
  - goofing around with twins [18]
- [Organize your Repo](https://github.com/byandell/geyser/) [19]
  - Clone my Repo [20]
- Questions? Links to materials [21]
:::
...
moduleServer_log <- shiny::reactlog()
saveRDS(moduleServer_log, "moduleServer.rds")

# Retrieve previously saved reactive session.
moduleServer_log <- readRDS("moduleServer.rds")
reactlog::reactlog_show(moduleServer_log)
```

- [Shiny Reactlog](https://rstudio.github.io/reactlog/articles/reactlog.html)
- See [inst/reactlog](https://github.com/byandell/geyser/blob/main/inst/reactlog) examples saved as `RDS`.
- Re-open repo to reset `reactlog`.
...
## Connecting Modules with Rows and Columns
...
## Connecting Modules with Rows and Columns {.scrollable .smaller}
...
## Connecting Modules with Plot Type Switch
...
- <https://connect.doit.wisc.edu/geyserQuartoDemo>
  - See Quarto examples in various folders
