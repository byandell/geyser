...
- Connect Modules [10-16]
  - across [Pages](https://github.com/byandell/geyser/blob/main/inst/connect_modules/appPages.R) [10-11]
  - with [Rows and Columns](https://github.com/byandell/geyser/blob/main/inst/connect_modules/appRows.R) [12-13]
  - combined with [Switch](https://github.com/byandell/geyser/blob/main/inst/connect_modules/app.R) [14-15]
  - goofing around with twins [16]
- [Organize your Repo](https://github.com/byandell/geyser/) [17]
  - Clone my Repo [18]
- Questions? Links to materials [19]

#### Other Material

- [Geyser Shiny Demo](https://connect.doit.wisc.edu/geyserDemo)
- [Geyser Quarto Demo](https://connect.doit.wisc.edu/geyserQuartoDemo)
  - Quarto Code in most repo folders
:::
