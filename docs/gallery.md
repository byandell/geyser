...
To publish the gallery page to your live site, commit and push only the generated HTML page and Quarto file to GitHub:
* `docs/demo_gallery.qmd` (source Quarto file)
* `docs/demo_gallery.html` (rendered HTML page)
* `docs/shinylive-sw.js` (service worker script generated by Quarto)

Once pushed, your new gallery page will be live and fully interactive at:
