...
This section displays the [geyser Quarto Dashboard app](https://github.com/byandell/geyser/blob/main/inst/connect_modules/quarto/demo.qmd) hosted on Posit Connect, using an `iframe` embedding.
