...
This section displays the running version of the geyser app using the source code from [inst/connect_modules/demo](https://github.com/byandell/geyser/tree/main/inst/connect_modules/demo), powered directly in the page via the serverless **Shinylive** (WebAssembly).

This advanced app combines a central dataset selector module with multiple plotting and layout modules, allowing them to share state reactively. Below the application, you can view the source files for each of the modules in separate tabs.
