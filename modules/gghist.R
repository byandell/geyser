...
#' @importFrom ggplot2 aes after_stat geom_histogram geom_rug ggplot ggitlel
#'             stat_density xlab
#' @importFrom rlang .data
gghistServer <- function(id, df, column) {
